...
class _Server {
  ...
  new_client(socket) {
    ...
    var self = this;
    console.log('New client: ' + socket._socket.remoteAddress + ':' + socket._socket.remotePort);
    ...
    socket.on("message", function(data) {
      ...
      if(action == "REQUESTSTREAM") {
        self.start_feed();
        console.log('Start steamig to: ' + socket._socket.remoteAddress + ':' + socket._socket.remotePort);
      }
